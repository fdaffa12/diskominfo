...
@section ('title')
<title>{{$cat->title}} | DISKOMINFO</title>
@stop
@section ('content') 
	<div class="wrapper">
			...
			<div class="col-md-8">
				<div class="col-md-12" style="padding:15px 15px 30px 0px;">
					...
					<div class="col-md-12">
						...
						@if($key > 0 && $key <10)
						<div class="col-md-6">
							<a href="{{url('article')}}/{{$post->slug}}"><img src="{{url('public/posts')}}/{{$post->image}}" width="100%" style="margin-bottom:15px; height: 200px;" /></a>
							<h4><a href="{{url('article')}}/{{$post->slug}}">{{$post->title}}</a></h4>
							{!! substr($post->description,0,300) !!}
							<p><a href="{{url('article')}}/{{$post->slug}}">Read more &raquo;</a></p>
						</div>
			...
			<div class="col-md-4">
				<div class="col-md-12" style="padding:15px;">
					...
					<div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
						<div class="col-md-4">
							<div class="row">
								<a href="{{url('article')}}/{{$l->slug}}"><img src="{{url('public/posts')}}/{{$l->image}}" width="100%" style="margin-left:-15px;" />
							</div>
						</div>
						<div class="col-md-8">
